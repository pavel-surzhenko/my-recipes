...
const FoodCard: React.FC<foodCardProps> = ({ name, category, images, _id, time }) => {
    return (
        <div className='bg-secondary dark:bg-secondaryDark rounded-md space-y-3 flex flex-col min-w-[250px] max-w-[300px] shadow-card hover:shadow-cardHover h-full hover:-translate-y-2 transition-all duration-300'>
