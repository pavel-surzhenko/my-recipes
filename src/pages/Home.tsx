...
import { foodCardProps_old, foodCategory } from '../types';
...
const Home = () => {
    const [randomFood, setRandomFood] = useState<foodCardProps_old>();
    const [allFood, setAllFood] = useState<foodCardProps_old[]>();
